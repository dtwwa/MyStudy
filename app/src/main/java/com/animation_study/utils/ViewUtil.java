package com.animation_study.utils;
...
public class ViewUtil {
    ...
    public static Point getScreenSize() {
        ...
        CrashApplication.wm.getDefaultDisplay().getMetrics(metrics);
    ...
    public static int dip2px(float dpValue) {
        final float scale = CrashApplication.context.getResources().getDisplayMetrics().density;
